...
//
//import static com.kenza.clickmachine.ClickMachine.SCREEN_HANDLER_TYPE;
//
...
//        super(SCREEN_HANDLER_TYPE, syncId, playerInventory, getBlockInventory(context, INVENTORY_SIZE), getBlockPropertyDelegate(context));
//
